...
echo "[install] Dashboard (loopback): curl -s http://127.0.0.1:8765/api/health | jq ."
echo "[install] Public bind: set API_HOST=0.0.0.0 in .env, restart v5-api,"
echo "          then open TCP 8765 in UFW / cloud firewall if you want browser access without SSH."
